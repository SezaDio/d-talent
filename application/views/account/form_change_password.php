				...
				<div class="col-lg-4" style="padding: 20px; background: white; border: solid 1px lightgray; border-radius: 5px; box-shadow: 5px 10px 12px lightgrey;">
					...
					<div class="omb_login">	
						<div class="row omb_loginOr">
							<div class="col-md-12">
								<hr class="omb_hrOr">
								<span class="omb_spanOr"><b>Change Password</b></span>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12" style="margin-top: 20px;">								
								...
								<?php if (empty($hideForm)) { //----------- FORM SHOWN ---------- ?>
									<div>
										<p>Change Password for <strong><?= $email;?></strong></p>
									</div>
									<form action="<?php echo htmlspecialchars($formAction); ?>" method="POST">
										<div class="form-group">
											<label for="acc_password">New Password</label> 
											<input id="acc_password" name="acc_password" type="password" class="form-control" required value="<?php echo htmlspecialchars(@$acc_password); ?>" />
											<span style="color: red;"><?php echo form_error('acc_password'); ?></span>
										</div>
										<div class="form-group">
											<label for="acc_password2">Confirm Password</label> 
											<input id="acc_password2" name="acc_password2" type="password" class="form-control" required value="<?php echo htmlspecialchars(@$acc_password2); ?>" />
											<span style="color: red;"><?php echo form_error('acc_password2'); ?></span>
										</div>
										<hr />
										<button type="submit" class="btn btn-primary"><i class="fa fa-mail-reply"></i> Submit</button>
