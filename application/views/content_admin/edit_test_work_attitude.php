<aside class="right-side">
    ...
    <section class="content-header" style="margin-top: 45px;">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-dashboard"></i>Kelola Tes Work Attitude</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" action="<?php echo site_url('admin/test-work-attitude/update/') . $test->id_test_work_attitude;?>" method="POST">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('admin/test-work-attitude');?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Batal</a>
                        </div>
                    </form>
