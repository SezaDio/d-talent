...
<aside class="right-side">
                ...
                <section class="content-header" style="margin-top: 45px;">
                    <h1>
                       Tambah Slider Mobile
                    </h1>
					<div id="instafeed"></div>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>Kelola Slider</a></li>
                        <li class="active">Tambah Slider Mobile</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form" enctype="multipart/form-data" action="<?php echo site_url('KelolaSlider/tambah_small_slider_check/');?>" method="POST">
                                    <div class="box-body">
