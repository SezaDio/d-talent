	...
	<div class="online-test">
		...
		<div>
			...
			?>				
				<br><br>
				<div class="row">
					<div class="col-md-6 soft-skill-subtitle">
						<div class="row">
							<div class="col-md-12" style="border: solid 1px lightgray; box-shadow: 0px 0px 20px lightgrey; padding: 10px;">
								<div class="clearfix" style="background-color: black; border: solid 2px black;">
									<div class="col-md-12" style="padding: unset; text-align: center; color: white;">
					    				<h3 style="font-size: 2.0em;"><b>INTRAPERSONAL SKILL</b></h3>
					    			</div>
					    		</div>
							...
							<div class="col-md-12" style="border: solid 1px lightgray; box-shadow: 0px 0px 20px lightgrey; padding: 10px;">
						 		<div class="clearfix" style="background-color: white; border: solid 2px black;">
							 		<div class="col-md-12" style="text-align: center;">
					    				<h3 style="font-size: 2.0em;"><b>INTERPERSONAL SKILL</b></h3>
					    			</div>
					    		</div>
